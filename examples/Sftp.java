...
//		out.println(vv.elementAt(ii).toString());
                ...
                if(obj instanceof net.agilhard.jsch.ChannelSftp.LsEntry){
                  out.println(((net.agilhard.jsch.ChannelSftp.LsEntry)obj).getLongname());
                }
...
/*
  public static class MyProgressMonitor implements net.agilhard.jsch.ProgressMonitor{
